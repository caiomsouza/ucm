...
length _Pformat1 $58;
drop _Pformat1;
_Pformat1 = strip(put(DEFAULT, COMMA10.2));
if
_Pformat1 = '0.00'
then do;
if (890+1-_C000004)*_genvalue_ <= (356 - _C000001) then do;
_C000001 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (890+1-_C000004)*_genvalue_ <= (356 - _C000001 + 267 - _C000002) then do;
_C000002 + 1;
...
_Pformat1 = '1.00'
then do;
if (104+1-_C000008)*_genvalue_ <= (42 - _C000005) then do;
_C000005 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (104+1-_C000008)*_genvalue_ <= (42 - _C000005 + 31 - _C000006) then do;
_C000006 + 1;
output EMWS1.Part_VALIDATE;
end;
else do;
