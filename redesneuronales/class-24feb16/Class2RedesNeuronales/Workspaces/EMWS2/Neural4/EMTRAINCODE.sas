...
Prelim 5 preiter=10
pretime=3600
Outest=EMWS2.Neural4_PRELIM_OUTEST
;
save network=EMWS2.Neural4_NETWORK.dm_neural;
train Maxiter=50
maxtime=14400
Outest=EMWS2.Neural4_outest estiter=1
Outfit=EMWS2.Neural4_OUTFIT
;
run;
quit;
proc sort data=EMWS2.Neural4_OUTFIT(where=(_iter_ ne . and _NAME_="OVERALL")) out=fit_Neural4;
by _AVERR_;
run;
%GLOBAL ITER;
data _null_;
...
run;
data EMWS2.Neural4_INITIAL;
set EMWS2.Neural4_outest(where=(_ITER_ eq &ITER and _OBJ_ ne .));
run;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
proc neural data=EM_Neural4 dmdbcat=WORK.Neural4_DMDB
network = EMWS2.Neural4_NETWORK.dm_neural
random=12345
;
nloptions noprint;
performance alldetails noutilfile;
initial inest=EMWS2.Neural4_INITIAL;
train tech=NONE;
code file="C:\Users\win\Documents\GitHub\ucm\redesneuronales\class-24feb16\Class2RedesNeuronales\Workspaces\EMWS2\Neural4\SCORECODE.sas"
group=Neural4
;
;
code file="C:\Users\win\Documents\GitHub\ucm\redesneuronales\class-24feb16\Class2RedesNeuronales\Workspaces\EMWS2\Neural4\RESIDUALSCORECODE.sas"
group=Neural4
residual
;
;
...
run;
quit;
data EMWS2.Neural4_OUTFIT;
merge WORK.FIT1 WORK.FIT2;
run;
data EMWS2.Neural4_EMESTIMATE;
set EMWS2.Neural4_outest;
