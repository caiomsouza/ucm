...
Prelim 5 preiter=10
pretime=3600
Outest=EMWS2.Neural3_PRELIM_OUTEST
;
save network=EMWS2.Neural3_NETWORK.dm_neural;
train Maxiter=50
maxtime=14400
Outest=EMWS2.Neural3_outest estiter=1
Outfit=EMWS2.Neural3_OUTFIT
;
run;
quit;
proc sort data=EMWS2.Neural3_OUTFIT(where=(_iter_ ne . and _NAME_="OVERALL")) out=fit_Neural3;
by _AVERR_;
run;
%GLOBAL ITER;
data _null_;
...
run;
data EMWS2.Neural3_INITIAL;
set EMWS2.Neural3_outest(where=(_ITER_ eq &ITER and _OBJ_ ne .));
run;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
proc neural data=EM_Neural3 dmdbcat=WORK.Neural3_DMDB
network = EMWS2.Neural3_NETWORK.dm_neural
random=12345
;
nloptions noprint;
performance alldetails noutilfile;
initial inest=EMWS2.Neural3_INITIAL;
train tech=NONE;
code file="C:\Users\win\Documents\GitHub\ucm\redesneuronales\class-24feb16\Class2RedesNeuronales\Workspaces\EMWS2\Neural3\SCORECODE.sas"
group=Neural3
;
;
code file="C:\Users\win\Documents\GitHub\ucm\redesneuronales\class-24feb16\Class2RedesNeuronales\Workspaces\EMWS2\Neural3\RESIDUALSCORECODE.sas"
group=Neural3
residual
;
;
...
run;
quit;
data EMWS2.Neural3_OUTFIT;
merge WORK.FIT1 WORK.FIT2;
run;
data EMWS2.Neural3_EMESTIMATE;
set EMWS2.Neural3_outest;
