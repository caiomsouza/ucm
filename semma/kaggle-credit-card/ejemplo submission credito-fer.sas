...
libname kaggle 'C:\discoc\TRABAJO_3';
...
dominio1*flag2 dominio1*flag1 dominio1*campo2 dominio1*flag3 dominio1*campo5
dominio1*indicador1 dominio1*indicador2 dominio1*flag4 estado1*indicador2 estado1*campo2
estado1*cantidad estado1*campo4 estado1*total estado1*flag1 estado1*campo3 estado1 estado1*id
estado1*zip1 estado1*flag2 estado1*campo5 estado1*hora2 estado1*indicador1 estado1*hora1
estado1*flag5 estado1*flag3 estado1*campo1 campo2 zip1 flag1 indicador2 indicador1 campo4
cantidad total flag2 estado1*flag4 id campo5 campo3 flag3 flag5 flag4 campo1 hora2 hora1
...
listconti=campo1 campo2 campo3 campo4 campo5 cantidad flag1 
flag2 flag3 flag4 flag5 hora1 hora2 id indicador1 indicador2 total zip1 ,
corte=90,directorio=C:\discoc\TRABAJO_3);
